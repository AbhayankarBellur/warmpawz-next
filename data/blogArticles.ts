...
export const blogArticles: BlogArticle[] = [
  {
    id: "breeds-of-dogs-cats-india",
    title: "Breeds of Dogs and Cats Available in India",
    excerpt: "Everything you ever wished to know about your furry babies—from Labradors to Indies, Persians to Desi cats—complete with care tips and expert insights.",
    ...
    content: [
      "Here we are, wanting to bring to you everything you ever wished to know about your furry babies. So we actually sent dog-loving boys and girls to fetch data for you. Here, we've put together every known detail with fact checks from the experts — doctors and pet parents alike. To kick-start our little data fetch, we barked up every right tree.",
      
      "So here goes — the most common and loved dog breeds for Indian homes:",
      
      "Labrador Retriever: Another name for active with oodles of gentleness! Labs become family members instantly. Keep them in your heart and let them stay there. With moderate grooming needs — thick, short coats that repel water and welcome dry cuddles — they're perfect for warm weather. Labs adapt well to apartment living if they get enough exercise. Here's your protein buddy — chicken and eggs partner — but don't worry, they enjoy almost all protein-rich foods.",
      
      "Golden Retriever: Get yourself a good dog coat brush, because here's a gorgeous mid-length coat dweller. He or she loves children, is a delight to train, and has affection as a middle name. Throw in all your love, generous space, daily walks, a balanced diet, and you'll have the shiniest friendship on the planet.",
      
      "Beagle: They say the best things come in small packages, and the Beagle proves it. Here's an energetic, curious, nose-poking buddy whose short coat keeps grooming easy. Be careful though—this binge eater can't tell if it's love for your food or plain hunger. Beagles are great for families who love playtime and laughter.",
      
      "Indian Pariah: Probably the most common and most underappreciated breed. The Indian Pariah is native, strong, and perfectly suited to our climate. Sharp, loyal, naturally healthy, and super adaptable, they fit beautifully in both independent homes and apartments. Minimal grooming, high intelligence, and loads of love—this desi buddy is India's true guardian.",
      
      "Pug: Keep them moderately groomed and always cuddled. Pugs are born comedians—funny, expressive, and full of charm. They shed both inhibition and hair, and heat can stress them out, so keep them cool and cozy. Small homes suit them just fine.",
      
      "German Shepherd: They are double friendly, double coated, double easy to train, and need double the effort for maintenance of their fur. German Shepherds are loyal, alert, and super intelligent—always ready to protect and please their families. Their thick coat sheds seasonally, so regular brushing keeps things tidy.",
      
      "Shih Tzu: Here's your royal fluff ball wrapped in love and luxury. Shih Tzus, once lap dogs of Chinese emperors, are affectionate, gentle, and charming. Their long, silky coats need daily brushing and occasional trims. Perfect for apartments, they're not big on workouts but huge on cuddles and companionship.",
      
      "Doberman: Sleek, strong, and supremely loyal. Dobermans are the guardians with golden hearts. Their short coat is easy to maintain, and they shed very little. Intelligent and athletic, they love outdoor play and thrive on structured training.",
      
      "Siberian Husky: The snow prince in the tropics. With piercing blue eyes and a majestic double coat, Huskies are breathtakingly beautiful. But beware—they're bred for cold climates, so they need shade, cool surroundings, and plenty of hydration in India.",
      
      "Persian Cat: The royal sofa queen (or king). With that long, luxurious coat and gentle eyes, Persians love peace and pampering. Daily brushing keeps their fur flawless. They prefer quiet spaces and soft laps, enjoying small, nutritious meals of fish or chicken.",
      
      "Siamese Cat: Talkative, curious, and clever—Siamese cats love to chat. Their short coats shed very little, and their blue eyes melt hearts. They follow you everywhere, eager to play or share their opinions.",
      
      "Indian (Indie/Desi) Cat: Agile, smart, and strong, these desi felines are true survivors. Perfectly adapted to Indian weather, they need minimal grooming and are rarely fussy eaters. Simple home-cooked meals and lots of freedom keep them healthy.",
      
      "Maine Coon: The gentle giant of cats. With tufted ears, bushy tails, and dog-like devotion, Maine Coons are affectionate and playful. Their thick fur needs brushing, but they're worth every moment.",
      
      "Ragdoll: True to their name, Ragdolls flop into your arms like soft toys. Sweet, patient, and loving, they adore being carried and cuddled. Their medium fur is silky and easy to maintain. Gentle with children and great with other pets, they're the ultimate family cats.",
      
      "Whether it's a wagging tail or a purring heart, every pet brings endless love, laughter, and lessons in loyalty. Groom them, feed them, play with them, and most importantly—love them. They'll make every day a little brighter and every heart a little softer."
    ]
  },
  {
    id: "golden-retriever-behaviour-issues",
    title: "Golden Retriever – Common Behaviour Issues and Solutions",
    excerpt: "Golden Retrievers are sunshine in fur—loyal, affectionate, and eager to please. Learn how to manage their enthusiastic habits with simple, loving solutions.",
    author: "Warmpawz Team",
    date: "January 5, 2026",
    readTime: "5 min read",
    category: "Behaviour",
    ...
    content: [
      "Golden Retrievers are sunshine in fur. They're loyal, affectionate, and always eager to please. But this very enthusiasm can sometimes lead to a few funny (and sometimes frustrating) habits.",
      
      "Chewing: They chew for comfort or out of sheer boredom. Those shiny shoes? Gone! Keep them busy with strong chew toys and daily playtime. A tired Golden is a good Golden.",
      
      "Jumping: Their love overflows—right onto your clothes. Teach them to sit before greeting. Calm gets cuddles; jumping gets ignored.",
      
      "Barking: They're talkative when left alone or seeking attention. Give them company, some puzzle toys, or gentle music when you're away.",
      
      "Pulling on Leash: Every walk feels like a race to happiness. Use a short leash, walk with patience, and reward gentle steps.",
      
      "Digging: Some dig out of joy, others for adventure. More playtime, less garden holes. Give them a 'dig zone' if they insist.",
      
      "With enough love, exercise, and a pinch of patience, your Golden will be that perfect, glowing bundle of joy who brightens every corner of your home."
    ]
  },
  {
    id: "why-indies-best-choice-india",
    title: "Why Indies Are the Best Pet Choice for Dog Lovers in India",
    excerpt: "Indies aren't 'strays'—they're survivors with soft hearts and street-smart souls. Discover why these desi dogs make the perfect companions.",
    author: "Warmpawz Team",
    date: "January 5, 2026",
    readTime: "5 min read",
    category: "Pet Care",
    ...
    content: [
      "Indies aren't 'strays.' They're survivors with soft hearts and street-smart souls. If loyalty had a face, it would wag its tail and answer to an Indie's name.",
      
      "Built by India, for India: Indie dogs are naturally adapted to our climate, roads, seasons, and rhythms. Their nutrition needs are refreshingly simple — balanced home food like rice, roti, vegetables, eggs, curd, or affordable commercial dog food works beautifully. No fancy imported kibble required, just love served in a bowl.",
      
      "Maintenance? Minimal: Their short coats don't demand salon visits every month, and their strong immunity means fewer vet visits when cared for responsibly. Regular vaccinations, deworming, clean water, and daily walks keep them thriving. Simple care, solid health.",
      
      "Cost of Care: This is where Indies truly shine. With lower grooming expenses, fewer hereditary health issues, and adaptable eating habits, they're kinder on the wallet — without ever compromising on companionship. They give you premium love at a very practical price.",
      
      "Challenges and Solutions: Yes, challenges exist. Some Indies may be cautious at first, shaped by past neglect. Others might carry minor street survival habits. The solution? Patience, routine, gentle training, and trust. What they lack in polish, they make up for in gratitude.",
      
      "Indies don't just become pets — they become family, guards, therapists, and teachers of resilience. When you choose an Indie, you don't just save a dog. You gain a best friend who already knows how precious love is.",
      
      "Once an Indie chooses you, your heart is theirs forever."
    ]
  },
  {
    id: "first-month-with-pet",
    title: "Your First Month with a Pet",
    excerpt: "A warm pause for the little one with warm paws! The first month with a new pet is life-altering—filled with joy, challenges, and profound emotional change.",
    author: "Warmpawz Team",
    date: "January 5, 2026",
    readTime: "5 min read",
    category: "Pet Care",
    ...
    content: [
      "The first month with a new family member who has four paws is nothing short of life-altering. It begins with excitement — new bowls, a tiny bed, that first car ride home — but quickly unfolds into something deeper, quieter, and far more powerful. Your days start revolving around feeding times, bathroom breaks, and tentative tail wags. Your nights grow lighter, even with interrupted sleep, because there's a small heartbeat trusting you completely.",
      
      "In just a few weeks, routines shift. You wake up earlier, step outside more often, notice the sky, the wind, the small joys you once rushed past. Laughter becomes frequent — at clumsy jumps, crooked zoomies, and the way they somehow steal socks and hearts at the same speed. There are challenges too: chewed corners, accidents, moments of doubt. But every problem brings a solution rooted in patience, consistency, and learning together.",
      
      "What truly surprises you is the emotional change. Pets don't just live in your home; they live in your moments. They sense your stress, sit closer on hard days, and celebrate ordinary wins like they're milestones. The house feels fuller, warmer, more alive. Silence feels strange without their presence.",
      
      "By the end of the first month, you realise something profound — you didn't just adopt a pet, you adopted a new way of living. One with responsibility, empathy, structure, and unconditional love. Pets change your lives forever, not loudly or dramatically, but gently, steadily, and always for the better.",
      
      "The first month is just the beginning. The love lasts forever."
    ]
  },
  {
    id: "pet-vaccinations-india",
    title: "Pet Vaccinations in India",
    excerpt: "Pet vaccinations are a quiet kind of love—steady, responsible, and deeply protective. Complete vaccination schedules for puppies, kittens, and adult pets in India.",
    author: "Warmpawz Team",
    date: "January 5, 2026",
    readTime: "8 min read",
    category: "Healthcare",
    ...
    content: [
      "Pet vaccinations in India are a quiet kind of love. Not flashy, not Instagrammable — but steady, responsible, and deeply protective.",
      
      "That first vet visit usually comes with a mix of nerves and hope — a tiny paw on the table, wide eyes looking up at you as if to ask, 'You've got me, right?' And you do. Vaccines are your promise kept.",
      
      "In a country like ours — warm, bustling, beautifully chaotic — diseases travel fast. Parvo, distemper, leptospirosis and rabies don't care how loved a pet is. What they do respect is prevention. A few timely injections can save months of heartbreak, hospital visits, and helpless waiting.",
      
      "And cats — especially the ones who pretend they don't need us — need this protection just as much. Feline panleukopenia, calicivirus, herpesvirus and rabies are silent, serious threats. Indoor royalty or balcony explorers, vaccination keeps their independence intact.",
      
      "There may be mild fever, a quiet day, extra cuddles demanded — or dramatic sulking. That's normal. What follows is freedom: to play, to explore, to nap in peace, to grow old with curiosity intact.",
      
      "Vaccinating your pet isn't about fear. It's about foresight. About choosing care before crisis. About saying, 'I plan to keep you safe for as long as I can.'",
      
      "Because love isn't just treats and toys. Sometimes, love is a small needle, a steady hand, and a lifetime of wagging tails and grateful purrs.",
      
      "Protect today. Cherish tomorrow."
    ]
  },
  {
    id: "hair-shedding-in-dogs-cats",
    title: "Hair Shedding in Popular Dog & Cat Breeds",
    excerpt: "Or: Why your house looks like it adopted a fur coat. Shedding is not a flaw—it's a feature. Learn to manage it with practical tips and a sense of humor.",
    author: "Warmpawz Team",
    ...
    content: [
      "Shedding is not a flaw. It's a feature. A seasonal, emotional, sometimes dramatic feature. All pets shed—some politely, some like they're auditioning for a wool factory.",
      
      "**Common Dog Breeds & Their Shedding Styles**",
      
      "**Labrador Retriever:** Sheds like it's a full-time job. Short hair, but plenty of it. Peaks during seasonal changes. Why? Dense double coat built for swimming and weather. Reality check: You'll find fur in places the dog hasn't visited.",
      
      "**Golden Retriever:** Graceful. Loving. Floats fur instead of shedding it. Why? Long double coat + constant renewal. Reality check: Your black clothes are no longer black.",
      
      "**German Shepherd:** The OG 'shedding machine.' Why? Thick undercoat that blows out seasonally. Reality check: Vacuum considers this breed a personal challenge.",
      
      "**Beagle:** Short-haired but sneaky shedder. Why? Dense coat + active skin turnover. Reality check: You don't see it coming. It's already there.",
      
      "**Indie Dogs (Indian Pariah Dogs):** Low to moderate shedding. Why? Naturally adaptive coat. Reality check: Minimal fuss, maximum practicality.",
      
      "**Common Cat Breeds & Their Shedding Quirks**",
      
      "**Indian Domestic Cat (Indie Cats):** Low to moderate shedding. Why? Short, climate-friendly coat. Reality check: Self-grooming champions.",
      
      "**Persian Cats:** Luxury comes at a price—hair. Lots of it. Why? Long, thick coat with daily maintenance needs. Reality check: Skipping grooming is not an option.",
      
      "**Maine Coon:** Majestic and floofy. Seasonal heavy shedding. Why? Weather-resistant coat. Reality check: Fur tumbleweeds are real.",
      
      "**Siamese Cats:** Minimal shedding. Maximum attitude. Why? Short, fine coat. Reality check: Your furniture survives, barely.",
      
      "**Blanket Solutions & Home Remedies** (Because shedding is manageable, not a crisis)",
      
      "1. **Brush. Then brush again.** 3–4 times a week for heavy shedders. Daily for long coats. Removes loose fur before it redecorates your home.",
      
      "2. **Nutrition matters (a lot).** Good protein, omega-3s (fish oil, flaxseed), and proper hydration = healthier skin = less shedding.",
      
      "3. **Regular baths, not overbaths.** Once every 3–4 weeks with pet-safe shampoo. Overwashing dries skin → more shedding.",
      
      "4. **Coconut oil massage (yes, really).** Tiny amounts, once a week. Great for dry skin and shine. Patch test first.",
      
      "5. **Clean environment = less fur panic.** Wash bedding weekly. Use lint rollers unapologetically. Accept your fate kindly.",
      
      "6. **Vet check if shedding is sudden or extreme.** Hair loss ≠ shedding. Rule out allergies, parasites, hormonal issues.",
      
      "**Final Truth:** Shedding doesn't mean your pet is unhealthy. It means they're alive, growing, adapting—and leaving tiny reminders of their love everywhere. Fur on your clothes. Fur on your sofa. Fur in your heart. Worth it. Always."
    ]
  },
  {
    id: "neutering-spaying-responsible-love",
    title: "Neutering & Spaying: Responsible Love, Not Fear",
    excerpt: "Think of neutering and spaying as responsible love—not fear, not deprivation, just good parenting. Learn why it matters and how it helps.",
    author: "Warmpawz Team",
    date: "January 8, 2026",
    readTime: "5 min read",
    category: "Health",
    ...
    content: [
      ...
      "**The ethics bit (because it matters):** Neutering and spaying aren't about control or convenience—they're about responsibility. Our pets don't choose the world they're born into, the streets outside, or the risks that come with unchecked breeding. As caretakers, we make decisions in their best interest, balancing individual welfare with the larger good. Preventing suffering, abandonment, and preventable disease is an ethical choice rooted in compassion, not dominance. When done safely and thoughtfully, sterilisation protects animals who already exist—rather than creating lives we may not be able to care for well. That's not interference. That's stewardship."
    ]
  },
  {
    id: "cone-chronicles-beating-frustration",
    title: "The Cone Chronicles: How to Beat the Frustration",
    excerpt: "The cone—also known as the lamp, the satellite dish, or the ultimate test of patience. Learn how to help your pet (and yourself) survive it.",
    author: "Warmpawz Team",
    date: "January 6, 2026",
    readTime: "4 min read",
    category: "Pet Care",
    ...
    content: [
      ...
      "Now, the frustration. Pets may freeze, sulk, bump into furniture, or stare at you with deep betrayal in their eyes. This is where you step in—with calm energy, reassurance, and a bit of creativity. **Keep routines steady.** Feed them at the usual time. Walk them on familiar routes. Normalcy helps them accept the new accessory faster than dramatic sympathy ever will.",
      
      "**Practical hacks help.** Make sure the cone fits right—not too tight, not comically large. Soft cones or inflatable collars work well for many pets, especially cats or gentle dogs, as long as the wound remains protected. Elevate food and water bowls so eating doesn't feel like a daily struggle. Clear tight spaces; your furniture will thank you.",
      
      "Most importantly, **replace frustration with connection.** Extra cuddles (cone-friendly), slow praise, puzzle toys, and calm company go a long way. Healing is easier when pets feel safe, not sorry for themselves.",
  ...
  {
    id: "cats-litterbox-love-story",
    title: "Cats and the Litterbox: A Love Story (Mostly)",
    excerpt: "Cats are born knowing many things—including where to pee. Pee-training a cat is less 'training' and more 'not messing it up.'",
    author: "Warmpawz Team",
    date: "January 4, 2026",
    readTime: "4 min read",
    category: "Training",
  ...
  {
    id: "funny-cat-behaviours",
    title: "10 Funny Cat Behaviours That Make Them Utterly Adorable",
    excerpt: "Cats don't try to be funny. That's the joke. They simply exist—and comedy happens around them.",
    author: "Warmpawz Team",
    date: "January 2, 2026",
    readTime: "3 min read",
    category: "Behaviour",
    ...
    content: [
      "Cats don't try to be funny. That's the joke. They simply exist—and comedy happens around them.",
      
      "**1. The Sudden Sprint** Nothing is chasing them. Everything is chasing them. Zoom.",
      
      "**2. Sitting in Squares (or Anything Square-ish)** A box. A lid. A random sheet of paper. If it has edges, it has purpose.",
      
      "**3. Knocking Things Off… Slowly** Maintaining eye contact. Testing gravity. Repeating the experiment.",
      
      "**4. The 3 a.m. Opera** A solo performance for an audience of one. You. Lucky you.",
      
      "**5. The Laptop Lie-Down** Your work clearly needs warmth. And fur. Mostly fur.",
      
      "**6. The 'I Fit, Therefore I Sit' Logic** Half a body in. Tail out. Success.",
      
      "**7. The Sudden Affection Attack** Ignore you all day. Sit on your chest the moment you're busy.",
      
      "**8. Talking Back** You speak. They reply. You don't understand a word—but the tone is clear.",
      
      "**9. The Existential Stare at Nothing** Is it a ghost? A thought? We may never know.",
      
      "**10. Pretending They Didn't Do That** Mischief committed. Face wiped clean. Innocence restored.",
      
      "Living with a cat is living with quiet chaos—soft, funny, unpredictable chaos that curls up beside you and purrs. And honestly, we wouldn't have it any other way."
    ]
  },
  {
    id: "transitioning-from-winter",
    title: "Transitioning from Winter: A Gentle Pet Care Guide",
    excerpt: "Winter tiptoes out in India—not with drama, just confused mornings and surprise afternoons. Help your pet adjust with these simple, thoughtful tips.",
    author: "Warmpawz Team",
  ...
  {
    id: "puppy-training-truths",
    title: "A Dozen Puppy Training Truths (From Someone Who's Been Outsmarted by a Puppy)",
    excerpt: "Training a puppy isn't about obedience. It's about negotiation. With someone who doesn't speak your language, chews your slippers, and still manages to steal your heart before breakfast.",
    author: "Warmpawz Team",
    ...
    content: [
      "Training a puppy isn't about obedience. It's about negotiation. With someone who doesn't speak your language, chews your slippers, and still manages to steal your heart before breakfast.",
      
      "Start early. Puppies are like soft clay—adorable, wiggly clay. Shape gently.",
      
      "Consistency beats intensity. Five calm minutes every day works far better than one dramatic weekend of rules and resolve. Reward the good and quietly ignore the oops. Puppies repeat what gets applause.",
      
      "Timing is everything. Praise immediately—puppies live fully, unapologetically, in the now.",
      
      "Names matter. Say it kindly. A puppy's name should always sound like an invitation, never a warning. 'Sit' is the gateway skill. Once they learn it, half of daily life suddenly becomes easier.",
      
      "Biting is communication. Redirect instead of scolding. Teething happens. Furniture forgives… slowly.",
      
      "Socialisation is education. New people, sounds, places, and dogs teach confidence better than commands ever will. Potty training needs patience, not punishment. Accidents are lessons, not failures. End training sessions on a win. Leave them feeling proud, not tired or confused.",
      
      "Your mood trains them too. Calm hands and soft voices raise calmer dogs.",
      
      "And finally—love is the secret sauce. Skills may fade, commands may wobble, but trust stays.",
      
      "Puppy training is messy, repetitive, and often hilarious. Some days you'll feel like a trainer. Other days, a very loyal snack dispenser.",
      
      "Stay kind. Stay patient. One day, without warning, they'll listen—and your heart will do a little sit-stay too."
    ]
  },
  {
    id: "best-foods-senior-dogs-india",
    title: "Best Foods for Senior Dogs in India: Feeding the Golden Years Right",
    excerpt: "Senior dogs don't suddenly grow old. They soften into it. A slower walk, longer naps, wiser eyes—and a tummy that now prefers comfort over drama.",
    author: "Warmpawz Team",
    date: "January 20, 2026",
    readTime: "2 min read",
    category: "Pet Care",
    ...
    content: [
      ...
      "Protein still matters—but quality matters more than quantity. Think boiled chicken, fish, eggs, or well-cooked paneer in moderation. Protein helps maintain muscle mass, which seniors quietly lose if we're not careful.",
      
      "Carbohydrates should be light and friendly. Rice, oats, ragi, and sweet potato work beautifully in Indian homes. Skip heavy wheat and anything too oily—it only invites bloating and discomfort.",
      
      "Fats? Yes, but wisely. A little coconut oil or fish oil supports joints, skin, and that dignified senior shine. Too much, however, turns walks into waddles.",
      
      "Fibre is your quiet hero. Pumpkin, bottle gourd, carrots, and green beans help digestion and keep constipation away—an unspoken but very real senior issue. If you prefer commercial senior dog food, choose brands available in India that clearly mention senior formulation, joint support, and controlled calories. Always transition slowly—old stomachs dislike surprises.",
  ...
  {
    id: "understanding-pet-insurance-india",
    title: "Understanding Pet Insurance in India: A Little Safety Net for Big Love",
    excerpt: "Bringing a pet into your life is like opening your heart without a lock. There's joy, mischief, muddy paws—and yes, the occasional vet bill that makes you blink twice.",
    author: "Warmpawz Team",
    date: "January 20, 2026",
    readTime: "2 min read",
    category: "Pet Care",
    ...
    content: [
      "Bringing a pet into your life is like opening your heart without a lock. There's joy, mischief, muddy paws—and yes, the occasional vet bill that makes you blink twice. That's where pet insurance quietly steps in, not to replace love, but to protect it.",
      
      "In India, pet insurance is still a growing concept. Simply put, it helps cover unexpected medical expenses—accidents, illnesses, surgeries, and sometimes even hospitalisation. You pay a small annual premium, and in return, you don't have to choose between panic and payment when your pet needs care now.",
      
      "Most Indian pet insurance plans primarily cover dogs, though cat coverage is slowly finding its feet. Policies usually include accident cover, illness-related treatment, and in some cases, third-party liability (helpful if your dog's enthusiasm knocks over more than just hearts). Routine care like vaccinations, grooming, or food is usually not covered—think of insurance as a rainy-day umbrella, not everyday sunshine.",
      
      "The key is reading the fine print—age limits, breed-specific conditions, waiting periods, and exclusions matter. An Indie may be easier (and cheaper) to insure than some pedigree breeds prone to genetic issues. Honesty about your pet's health history helps avoid heartbreak later.",
      
      "Is pet insurance mandatory? No.",
      
      "Is it thoughtful? Absolutely.",
      
      "For many pet parents, insurance brings peace of mind. It allows decisions to be guided by care, not cost, by love, not last-minute calculations.",
      
      "Because when they look at you—tail wagging, whiskers twitching—they're not thinking about premiums or policies.",
      
      "They're thinking, 'You've got me, right?'",
      
      "Pet insurance is one small way of saying, 'Always.'"
    ]
  },
  {
    id: "well-known-insurance-companies-pet-policies-india",
    title: "Well-Known Insurance Companies Offering Pet Policies in India",
    excerpt: "Bajaj Allianz General Insurance – One of the more popular and established providers, offering dog insurance that can include hospitalisation, surgery, third-party liability and optional add-ons like OPD and vaccination coverage.",
    author: "Warmpawz Team",
    date: "January 20, 2026",
    readTime: "1 min read",
    category: "Pet Care",
    ...
    content: [
      "Bajaj Allianz General Insurance – One of the more popular and established providers, offering dog insurance that can include hospitalisation, surgery, third-party liability and optional add-ons like OPD and vaccination coverage.",
      
      "HDFC ERGO / Vetic Shield Pet Insurance – Offers coverage for accidents, illnesses, surgeries and vet costs. Some policies can cover multiple pets under one plan, though user experience varies so read reviews before you buy.",
      
      "Future Generali India Insurance – A long-standing insurer in India with dog health plans focusing on essential accident and illness protection.",
      
      "Digit Insurance (with Vetina) – Digit's pet plan is popular for a more digital, easy-to-manage experience and options for both dogs and cats.",
      
      "New India Assurance – A trusted public sector insurer that offers dog insurance covering accident, disease and liability costs.",
      
      "Oriental Insurance – Another well-known public sector name with pet insurance that includes basic medical and hospital coverage.",
